let ColorPicker = function(elem, option){
...
$.extend(ColorPicker.prototype, {
  ...
  _render: function(){
    ...
    this.mousePick = function(x,y){
      ...
      let mx = !!x ? x : this.canvas.MaxRadius;
      let my = !!y ? y : this.mouseRound;
  ...
  getRgba: function(x,y){
    ...
    let hsl = this.getHsl(data[0],data[1],data[2]);
